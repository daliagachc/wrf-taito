...
SUBROUTINE HALO_EM_PHYS_HCW_sub ( grid, &
  local_communicator, &
...
CALL wrf_debug(2,'calling inc/HALO_EM_PHYS_HCW_inline.inc')
...
IF ( SIZE(grid%hailcast_wup_mask,1)*SIZE(grid%hailcast_wup_mask,2) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%hailcast_wup_mask, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, 1  , 1                )
ENDIF
IF ( SIZE(grid%hailcast_wdur,1)*SIZE(grid%hailcast_wdur,2) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%hailcast_wdur, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
4, 0, 0, DATA_ORDER_XY, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_EM_PHYS_HCW_sub
